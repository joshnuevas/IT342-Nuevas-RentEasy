...
export default function Cart() {
  ...
  useEffect(() => {
    const fetchCart = async () => {
      try {
        // Use encodeURIComponent to handle email characters like '@' or '.'
        const response = await fetch(`http://localhost:8080/api/cart?email=${encodeURIComponent(userEmail)}`, {
          headers: {
  ...
  // ... rest of your return statement stays EXACTLY as you wrote it
  return (
